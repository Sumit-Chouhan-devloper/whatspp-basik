            ...
            <div className=" pb-sm-5 mx-auto ff_inter text-center bg_gray">
                ...
                <div className="">
                    <div className="py-5 my-md-2">
                        <Image width={368} height={368} src="/assets/image/png/profilepopup.png" alt="Profile" className='py-lg-1 Profile_popup' />
                    </div>
                    <div className="profile_contact text-start bg-white ">
                        <h3 className='profile_parent mx-auto color_lite_green fw-normal fs_mmd opacity-75 mb-sm-0'>Your name</h3>
                        <div className="profile_parent mx-auto d-flex justify-content-between align-items-center">
                            ...
                            <Link href="/" className='pt-2'><Image className='mt-md-4 mb-0' src="/assets/image/svg/edit_pencil.svg" height={28} width={28} alt="Pencil" /></Link>
                        </div>
                    </div>
                    <p className='profile_parent mx-auto px-sm-0 profile_para text-start fs_mmd fs_mmd_sm color_dark_black opacity_70 mb-0'>This is not your username or pin. This name will be visible to your WhatsApp contacts.</p>
                    <div className="profile_contact text-start bg-white mb-sm-0 mb-3">
                        <h3 className='profile_parent mx-auto color_lite_green fw-normal fs_mmd opacity-75 mb-sm-0'>About</h3>
                        <div className="profile_parent mx-auto d-flex justify-content-between align-items-center">
