        ...
        <>
            <div className=" overflow-x-hidden ">
                ...
                <div className="bg-white channel min-vh-100">
                    ...
                    <div className="d-flex justify-content-between mt-5 px-3 channel">
