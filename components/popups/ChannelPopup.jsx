        ...
        <div className=" overflow-x-hidden container qr_scaner_box bg-brown SegoeUI px-0 ">
          ...
          <div className="bg-white channel min-vh-100 px-3">
            ...
            <div className="d-flex align-items-center gap-2">
              <p className="mt-4 fw-normal font-base color_gray">
            ...
            <h4 className=" color_gray m-0 mt-3 fw-normal font-base">
              18/10/2023
            </h4>
            ...
            <div className="d-flex justify-content-between">
              ...
              <h4 className=" font-base-03 fw-medium color_dark_green mt-4">
                Sell all &gt;
              </h4>
            </div>
