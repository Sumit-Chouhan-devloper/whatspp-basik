            ...
            <div className=" overflow-x-hidden ">
                ...
                <div className="bg-white channel min-vh-100">
                    <div className="channel_pera">
                        <p className="channel_pera_one font_19  text-center mb-1">Stay updated on your favourite topics</p>
                        <p className="channel_pera_two font_19  text-center mb-0">Find channels to follow below</p>
                    </div>
