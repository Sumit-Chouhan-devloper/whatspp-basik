        ...
        <>
            <div className="ff_inter  text-center">
                ...
                <div className="communitie_parent bg_white me-auto  d-flex flex-column min-vh-100">
                    <div className=" my-5 pb-md-2">
                        <Image width={360} height={200} src="/assets/image/png/communitie_pop.png" alt="Communityimg" className='pt-md-1 communityimg' />
                    </div>
                    <h1 className='font_24 font_xxl_19 fw-bold mb-0'>Stay connected with a community</h1>
                    <p className='px-2 px-sm-0 font_14 fw-normal color_dark_black community_para mx-auto my-3 '>
                    ...
                    <Link href="/" className="text-decoration-none color_sky_blue example_communities mb-5">See example communities  <Image width={10} height={13} src="/assets/image/svg/green_right_arrow.svg" alt="Right arrow" /></Link>
